  ...
  <body>
    ...
    <div class="row align-items-center content">
      <div id="pic1" class="col-md-6 px-0 order-2 order-md-1">
        <img src="public/imgs/milk.png" alt="" class="img-fluid">
      </div>
      <div class="col-md-6 px-0 text-center order-1 order-md-2">
        <div class="row justify-content-center">
          <div class="col-10 col-lg-8 blurb mb-5 mb-md-0">
              <h2>Museum of Candy</h2>
              <img src="public/imgs/lolli_icon.png" alt="" class="d-none d-lg-inline">
    ...
    <div class="row align-items-center content">
      ...
      <div class="col-md-6 px-0">
          <img src="public/imgs/gumball.png" alt="" class="img-fluid">
      </div>
      <div class="row align-items-center content">
          <div class="col-md-6 px-0 order-2 order-md-1">
            <img src="public/imgs/sprinkles.png" alt="" class="img-fluid">
          </div>
          <div class="col-md-6 px-0 text-center order-1 order-md-2">
            <div class="row justify-content-center">
              <div class="col-10 col-lg-8 blurb mb-5 mb-md-0">
