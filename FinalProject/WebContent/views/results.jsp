...
<!DOCTYPE html>
<html lang="en" ng-app="IndexApp" ng-controller="">
  <head>
    <!-- Required meta tags -->
    <!--  <meta charset="utf-8"> -->
  ...
  <body>
    ...
    <jsp:include page="navbar.jsp" />
   	...
   	<div class="jumbotron">
    	...
    	<hr class="my-4">
    	<p>Thanks for becoming a member of the Museum of Candy! Review the information you have submitted below. 
    		If there's an error, feel free to make an edit.
    	</p>
    	<p id="registration"></p>
	</div>
	...
	<form name="registration" class="jumbotron container" method="post" action="Get">
    	...
    	<div class="form-group">
            ...
            <input ng-model="age" type="text" class="form-control" id="age" name="age" aria-describedby="emailHelp" placeholder="Enter Age">
        </div>
        <div class="form-group">
